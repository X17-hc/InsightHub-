# InsightHub 第 1 周端到端演示：调用 Java API，校验 Markdown 与关键事件
...
$resp = Invoke-RestMethod -Uri "$JavaBase/api/v1/research/tasks" -Method Post -Body $body -ContentType "application/json; charset=utf-8"
